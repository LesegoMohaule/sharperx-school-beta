...
Use this if you want to recreate the page manually in Google Sites.
...
Study help that meets the learner where they are.

Learners can take a photo of a question, speak a voice note or type their working. The app responds with short, step-by-step guidance and then asks the learner to try.

Features:

- Photo homework help: Upload a question photo and get a clear explanation of the concept and first steps.
- Voice questions: Ask long questions by voice note instead of typing.
- Practice mode: Generate CAPS-style practice questions by grade, subject and topic.
- Mark my answer: Learners enter their steps and final answer, then receive corrections and weak-area feedback.
